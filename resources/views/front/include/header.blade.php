                        ...
                        <ul>
                            <li class="account dropdown">
                                ...
                                <ul class="dropdon-itme">
                                    ...
                                    <li><a href="{{route('admin.signup')}}">Sign Up</a></li>
                            ...
                            <li class="language dropdown">
                                <a href="#"> <img src="{{asset('front/images/flag.png')}}" alt="flag"> English <i class="angle-down fa fa-angle-down"></i></a>
                                <ul class="dropdon-itme">
                                    <li><a href="#"><img src="{{asset('front/images/flag.png')}}" alt="flag"> English</a></li>
                                    <li><a href="#"><img src="{{asset('front/images/flag.png')}}" alt="flag"> Dautch</a></li>
                                    <li><a href="#"><img src="{{asset('front/images/flag.png')}}" alt="flag"> Spanish</a></li>
                                    <li><a href="#"><img src="{{asset('front/images/flag.png')}}" alt="flag"> Hindi</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-6 col-6 order-0 order-lg-1">
                    <div class="brand-area">
                        <a href="index.html"><img src="{{asset('front/images/logo1.png')}}" alt="Woomart" /></a>
                    </div>
                </div>
                    ...
                    <div class="middle-right">
                        <ul>
                            ...
                            <li>
                                ...
                                <span class="card-amount">My Cart - ${{cartAmount()}}</span>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <li class="mega-menu-itms position-static">
                                ...
                                <ul class="mega-menu row">
                                    ...
                                    <li class="col-12 brad-logo-area">
                                        <div><a href="#"><img src="{{asset('front/images/brands/clients_logo1.png')}}" alt="clients_logo" /></a></div>
                                        <div><a href="#"><img src="{{asset('front/images/brands/clients_logo2.png')}}" alt="clients_logo" /></a></div>
                                        <div><a href="#"><img src="{{asset('front/images/brands/clients_logo3.png')}}" alt="clients_logo" /></a></div>
                                        <div><a href="#"><img src="{{asset('front/images/brands/clients_logo4.png')}}" alt="clients_logo" /></a></div>
                                        <div><a href="#"><img src="{{asset('front/images/brands/clients_logo5.png')}}" alt="clients_logo" /></a></div>
                                        <div><a href="#"><img src="{{asset('front/images/brands/clients_logo6.png')}}" alt="clients_logo" /></a></div>
                                        <div><a href="#"><img src="{{asset('front/images/brands/clients_logo7.png')}}" alt="clients_logo" /></a></div>
                                    </li>
                                </ul>
                            </li>
                            <li>
