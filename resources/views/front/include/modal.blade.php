                    ...
                    <div class="col-lg-6 ">
                        <div class="quick-view-image">
                            <div class="signle-image-product">
                                <a href="{{asset('front/images/gallery/original/04_g_car.jpg')}}" data-fancybox="gallery">
                                    <img class="example-image" src="{{asset('front/images/gallery/original/04_g_car.jpg')}}" alt="image-1">
                                </a>
                            </div>
                        </div>
                    </div>
